...
<div id="daddy">
	...
	<div id="content">
		...
		<div id="cB">
			<div class="titulo">SOLICITUD N° XXXX</div>
			<form name="frmsolicitudvista" id="frmsolicitudvista" action="<?=base_url();?>solicitud/insertar" method="post">
				<fieldset class="fieldcuerpo" align="left">
					<legend> DATOS SOLICITUD</legend>
					<table >
						<tr style="height: 30px;">
							<td width="100px" class="lblnombre">Usuario</td>
							<td width="240px" ><label name="nom_usu" class="txtcampo" readonly="" ></label></td>
						</tr>
						<tr style="height: 30px;">
							<td width="100px" class="lblnombre">Fecha</td>
							<td width="240px" ><label name="nom_usu" class="txtcampo" readonly="" ></label></td>
						</tr>
						<tr style="height: 30px;">
							<td width="100px" class="lblnombre">Tipo de solicitud</td>
							<td width="240px" ><label name="nom_usu" class="txtcampo" readonly="" ></td>
						</tr>
						<tr style="height: 30px;">
							<td width="100px" class="lblnombre">Archivos</td>
							<td width="240px" ><label name="nom_usu" class="txtcampo" readonly="" ></td>
						</tr>
				...
				<fieldset class="fieldcuerpo" align="left">
					<legend> DESCRIPCION</legend>
						<tr style="height: 30px;">
							<td width="100px" class="lblnombre">Motivos</td>
							<td width="240px" ><label name="mot_sol" class="txtcampo" readonly="" ></label></td>
						</tr>
