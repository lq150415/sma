...
<div id="daddy">
	...
	<div id="header">
		...
		<div id="menu">
			<ul>
				<li><a href="<?= base_url('views/archivo_personal/principal');?>" id="active">Principal</a></li>
				<li><a href="<?= base_url('templates/img/images/logo.png');?>">C.S.I.</a></li>
				<li><a href="<?= base_url('templates/img/images/logo.png');?>">C.P.I.</a></li>
				<li><a href="<?= base_url('templates/img/images/logo.png');?>">Solicitudes</a></li>
				<li><a href="<?= base_url('templates/img/images/logo.png');?>">Notificaciones</a></li>
				<li><a href="<?= base_url('templates/img/images/logo.png');?>">Devoluciones</a></li>
			</ul>
		</div>
		<!-- ticker -->
		<div id="ticker">
	...
	<div id="content">
		...
		<div id="cB">
			<div class="titulo">REGISTRAR RETIRO DE ARCHIVOS - CSI</div>
				...
				<fieldset class="fieldcuerpo" align="left">
					...
					<table >
						<tr style="height: 30px;">
							<td width="100px" class="lblnombre">Fecha de Retiro</td>
							<td width="240px" ><input type="text" name="fec_ret" class="txtcampo datepicker" readonly="" placeholder="FECHA INICIAL" ></td>
						<tr>
							<td width="100px" class="lblnombre">Tipo de Retiro</td>
							<td width="240px" >
									<select name="tip_ret" class="txtselect">
										<option value="">SELECCIONE</option>
										<option value="LP">DEFINITIVO</option>
										<option value="OR">TEMPORAL</option>
									</select>								
							</td>
						</tr>
						</table>
