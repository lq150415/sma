...
<div id="daddy">
	...
	<div id="content">
		...
		<div id="cB">
			<div class="titulo">REGISTRAR DATOS DE SOLICITUD DE RETIRO DE ARCHIVOS - CSI</div>
			<form name="frmsolicitud" id="frmsolicitud" action="<?=base_url();?>solicitud/insertar" method="post">
				<fieldset class="fieldcuerpo" align="left">
					...
					<table >
						...
						<tr style="height: 30px;">
							<td width="100px" class="lblnombre">Fecha de entrega</td>
							<td><input type="text" name="fec_ent" class="txtcampo datepicker" readonly="" placeholder="FECHA INICIAL" ></td>
						</tr>
						</table>
						<table>
						<tr>
							...
							<td width="500px">
								<textarea name="obs_ret" rows="600" cols="300px" class="txtselect"></textarea> 
							</td>
						</tr>
					</table>
				</fieldset>
